...
class TestCalliope(unittest.TestCase):
    def test_needs_service_battery_overdue(self):
    ...
    def test_needs_service_battery_not_due(self):
        today = datetime.today().date()
    ...
    def test_needs_service_engine_overdue(self):
    ...
    def test_needs_service_engine_not_due(self):
        last_service_date = datetime.today().date()
